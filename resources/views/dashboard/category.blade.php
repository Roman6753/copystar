<x-layouts.dashboard>
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                ...
                <button onclick="document.getElementById('importCategoryModal').showModal()"
    ...
    <dialog id="importCategoryModal" class="modal">
        <div class="modal-box">
            <h3 class="font-bold text-lg">Import Categories</h3>
            <form action="{{ route('categories.import') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                @csrf
                ...
                <div class="modal-action">
                    ...
                    <button type="button" onclick="document.getElementById('importCategoryModal').close()" 
