<x-layouts.dashboard>
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                ...
                <button onclick="document.getElementById('importUserModal').showModal()"
    ...
    <dialog id="importUserModal" class="modal">
        <div class="modal-box">
            ...
            <form action="{{ route('users.import') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                @csrf
                <div class="form-control">
                    ...
                    <div class="mt-2 p-2 bg-gray-100 rounded text-sm">
                        ...
                        <p>Name, Email, Avatar (optional)</p>
                    </div>
                </div>
                <div class="modal-action">
                    <button type="submit" class="btn btn-primary">Import</button>
                    <button type="button" onclick="document.getElementById('importUserModal').close()" 
